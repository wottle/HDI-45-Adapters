...
#### Final Assembly
1. First, solder the header pins. I have created a 3d printable jig in the /common directory to make this easier. See [pin assembly details](PIN_ASSEMBLY_DETAILS.md). 
